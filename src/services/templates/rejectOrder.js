const rejectOrder = ({ username, salonName, specialist, service, time, date }) => {
    ...
    <body style="margin: 0; padding: 0; background-color: #fff; font-family: Arial, sans-serif;">
        <div style="background-color: #FEF1EC; max-width: 600px; margin: 0 auto; padding-bottom: 30px; border-radius: 5px;">
            ...
            <div style="background-color: #F26D5C; height: 77px; display: flex; align-items: center; justify-content: center;">
                <p style="color: white; text-align: center; font-size: 32px; font-family: mart; margin: auto;">Appointment Cancelled!</p>
            </div>
            ...
            <h4 style="text-align: center; margin-left: 50px; margin-right: 50px;">
                We are sorry to inform that ${salonName?.charAt(0)?.toUpperCase() + salonName?.slice(1)} cannot process your order at this time. Try to book another salon or same salon at some other time. 
            </h4><br/>
            <h4 style="text-align: start; margin-left: 65px;">Order Details</h4>
            <div style="text-align: start; margin-left: 65px; margin-top: 15px;">
