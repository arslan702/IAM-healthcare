...
const CategoryModal = (props) => {
  ...
  return (
    <Modal
      title={props?.data ? "Update Specialist" : "Add New Specialist"}
      open={props.show}
      footer={null}
      onCancel={() => {
        props.setData(null);
        ...
        >
          <Form.Item
            ...
            rules={[
              {
                required: true,
                message: "Input Specialist name",
              },
            ]}
          >
            <Input placeholder="Specialist name" style={{ width: "100%" }} />
          </Form.Item>
          <Form.Item
            style={{ width: "100%" }}
            name="gender"
            rules={[
              {
                required: true,
                message: "Input Specialist Gender",
              },
            ]}
          >
